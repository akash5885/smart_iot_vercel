...
async function handler(req, res) {
  ...
  // Support users cannot control devices
  if (role === 'support') {
  ...
  try {
    ...
    // Customer can only control their own devices
    ...
    // Generate and insert a new reading
    const newReading = generateReadingAfterCommand(
      device.type,
      command,
      params,
